...
class stock_return_picking_memory(osv.osv_memory):
	...
	_columns = {
		'product_uop_qty' : fields.float("Qty UoP", digits_compute=dp.get_precision('Product Unit of Measure'), required=True),
	}
			...
			for line in pick.move_lines:
				...
				if qty > 0:
					result1.append({
						...
						'product_uop_qty' : line.product_uop_qty})
		...
		for v in val_id:
			...
			if new_qty:
				...
				new_move=move_obj.copy(cr, uid, move.id, {
                                            ...
                                            'product_uop_qty' : data_get.product_uop_qty or 0.0,
				})
