...
class account_balance(report_sxw.rml_parse):
    _name = 'report.account.balance.full.mirror'
...
report_sxw.report_sxw('report.account.balance.full.mirror', 'account.account', 'addons/ad_account_optimization/report/account_balance_full.rml', parser=account_balance, header=False)
