...
class account_chart(rml_parse.rml_parse):
    _name = 'report.account.chart.report'
    gadr_cpt = 0
...
report_sxw.report_sxw('report.account.chart.report', 'account.account','addons/ad_account_optimization/report/account_chart.rml', parser=account_chart, header=False)
