...
class LedgerCashBankWebkit(report_sxw.rml_parse,
	...
	def __init__(self, cursor, uid, name, context):
		...
		header_report_name = ' - '.join((_('Ledger GainLoss'), company.name,
	...
	def _compute_account_ledger_lines(self, accounts_id,
		...
		move_line_ids = self.get_move_lines_ids(accounts_id, main_filter, start, stop, target_move)
...
class LedgerGainLossXls(report_xls):
	...
	def generate_xls_report(self, _p, _xs, data, objects, wb):
		...
		for account in objects:
			...
			if _p.display_account_raw(data) == 'all' or  display_ledger_lines:
...
LedgerGainLossXls('report.account.account_ledger_gainloss_xls',
				  'account.account',
