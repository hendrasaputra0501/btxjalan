...
class AccountReportLedgerCashBank(orm.TransientModel):

	"""Will launch general ledger report and pass required args"""

	_inherit = "account.common.account.report"
	_name = "ledger.cashbank.webkit"
	_description = "Ledger CashBank"
	...
	def pre_print_report(self, cr, uid, ids, data, context=None):
		data = super(AccountReportLedgerCashBank, self).pre_print_report(
	...
	def _print_report(self, cursor, uid, ids, data, context=None):
		...
		return {'type': 'ir.actions.report.xml',
				'report_name': 'account.account_ledger_cashbank_xls',
				'datas': data}