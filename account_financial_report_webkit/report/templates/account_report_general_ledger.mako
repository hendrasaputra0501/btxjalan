            ...
            <div class="act_as_table list_table" style="margin-top: 10px;">
                ...
                <div class="act_as_tbody">
                      ...
                      %for line in ledger_lines[account.id]:
                        ...
                        total_balance_curr += line.get('amount_currency') or 0.0
                        total_balance += line.get('balance') or 0.0
                ...
                <div class="act_as_table list_table">
                    <div class="act_as_row labels" style="font-weight: bold;">
                        ...
                        <div class="act_as_cell" style="width: 260px;">${_("Total on Selected Period")}</div>
                        ## debit
                        <div class="act_as_cell amount" style="width: 75px;">${ formatLang(total_debit) | amount }</div>
                        ## credit
                        <div class="act_as_cell amount" style="width: 75px;">${ formatLang(total_credit) | amount }</div>
                        ## balance
                        <div class="act_as_cell amount" style="width: 75px; padding-right: 1px;">${ formatLang(total_balance) | amount }</div>
                        %if amount_currency(data):
                            %if account.currency_id:
                                ## currency balance
                                <div class="act_as_cell amount sep_left" style="width: 75px;">${formatLang(total_balance_curr) | amount }</div>
                            %else:
