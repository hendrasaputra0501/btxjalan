	...
	<body style='border:0; margin: 0;'>
		...
		<table width='100%' cellspacing='0' cellpadding='1'>
				...
				%if (bale_bal_qty >= min_bale_bal_qty) or bale_shipped_qty==0.0:
						...
						%if (group_name != old_group_name) or (loc_name != old_loc_name):
							%if old_group_name != "None":
								<tr>
									...
									<td class='subtotal' width='1%' align='left' colspan='12'>Total of ${old_group_name}</td>
									...
									<td class='subtotal' width='5%' align='right' colspan='11'>&nbsp;</td>
								</tr>
							%endif:
						%endif:
					%else:
						%if (subgroup2_name != old_subgroup2_name) or (subgroup_name != old_subgroup_name) or (group_name != old_group_name) or (loc_name != old_loc_name):
							%if old_subgroup2_name != "None":
								<tr>
									...
									<td class='detail' width='1%' align='left'>&nbsp;</td>
									<td class='detail' width='1%' align='left'>&nbsp;</td>
									<td class='subtotal' width='10%' align='left' colspan='10'>Total of ${old_subgroup2_name}</td>
									<td class='subtotal' width='5%' align='right'>${formatLang(subgroup2_product_uom_qty or 0.0,dp='Product Unit of Measure')}</td>
							...
							%if old_subgroup_name != "None":
								<tr>
									...
									%if data['form']['report_type'] == 'product':
										<td class='subtotal' width='1%' align='left' colspan='11'>Total of ${old_subgroup_name}</td>
									%else:
										<td class='subtotal' width='1%' align='left' colspan='11'>Total of ${old_subgroup_name}</td>
									%endif:			
					...
					%if loc_name != old_loc_name:
						%if old_loc_name != "None":
							<tr>
								%if data['form']['report_type'] != 'contract':
									<td class='subtotal' width='1%' align='left' colspan='13'>Total of ${old_loc_name}</td>
								%else:
						...
						<tr class='group' >
							%if data['form']['report_type'] != 'contract':
								<td class='group' width='1%' align='left' colspan='26'>${loc_name}</td>
							%else:
								<td class='group' width='1%' align='left' colspan='25'>${loc_name}</td>
							%endif:
						</tr>
					%endif:
					...
					%if data['form']['report_type'] == 'contract':
						%if group_name != old_group_name:
							...
							<tr class='group' >
								...
								<td class='group' width='1%' align='left' colspan='25'>${group_name}</td>
							</tr>
							<%group_product_uom_qty = 0.0%>
							<%group_bal_qty = 0.0%>
							<%subgroup_product_uom_qty = 0.0%>
					...
					%else:
						...
						%if subgroup_name != old_subgroup_name:
							...
							<tr class='group' >
								<td class='group' width='1%' align='left'>&nbsp;</td>
								<td class='group' width='1%' align='left'>&nbsp;</td>
								<td class='group' width='10%' align='left' colspan='24'>${subgroup_name}</td>
							</tr>
							<%subgroup_product_uom_qty = 0.0%>
							<%subgroup_bal_qty = 0.0%>
							<%subgroup2_product_uom_qty = 0.0%>
					...
					<%base_product_uom_qty = uom_to_bales(line['product_uom_qty'] or 0.0,line['product_uom'])%>
					<%base_bal_qty = uom_to_bales(line['bal_qty'] or 0.0,line['product_uom'])%>
					...
					%if data['form']['report_type'] == 'customer':
						<tr class='detail'>
							...
							<td class='detail' width='4%' align='right'>${formatLang(price_per_base(data,line['price_unit'] or 0.0,line['product_uom']),digits=4)}</td>
			               	<td class='detail' width='1%' align='left'>&nbsp;</td>
							<td class='detail' width='3%' align='left'>${xdate(line['sale_order_lsp'])}</td>
							...
							<td class='detail' width='5%' align='right'>${formatLang(base_product_uom_qty or 0.0,dp='Product Unit of Measure')}</td>
							<td class='detail' width='5%' align='right'>${formatLang(base_bal_qty or 0.0,dp='Product Unit of Measure')}</td>
							...
							<td class='detail' width='3%' align='right'>${formatLang(line['commission_percentage'] or 0.0,digits=2)}
		                    ...
		                    <td class='detail' width='3%' align='left'>${line['order_state'] or ''}</td>
					...
					%elif data['form']['report_type'] == 'product':
						<tr class='detail' >
			               	...
			               	<td class='detail' width='1%' align='left'>&nbsp;</td>
			               	<td class='detail' width='1%' align='left'>&nbsp;</td>
							<td class='detailcap' width='8%' align='left'>${line['product_descr'] or ''}</td>
							<td class='detailcap' width='7%' align='left'>${line['name'] or ''}</td>
							<td class='detail' width='4%' align='left'>${xdate(line['date_order'])}</td>
							<td class='detailcap' width='9%' align='left'>${line['customer_name'] or ''}</td>
							<td class='detailcap' width='5%' align='left'>${line['destination'] or ''}</td>
							<td class='detail' width='4%' align='right'>${formatLang(price_per_base(data,line['price_unit'] or 0.0,line['product_uom']),digits=4)}</td>
			               	<td class='detail' width='1%' align='left'>&nbsp;</td>
							<td class='detail' width='3%' align='left'>${xdate(line['sale_order_lsp'])}</td>
							...
							<td class='detail' width='4%' align='left'>${xdate(line['lc_lsd'])}</td>
		                    <td class='detail' width='3%' align='left'>${line['order_state'] or ''}</td>
		                    <td class='detail' width='4%' align='left'>${line['remarks'] or ''}</td>
						</tr>
					%elif data['form']['report_type'] == 'contract':
						<tr class='detail' >
			               	<td class='detail' width='1%' align='left'>&nbsp;</td>
			...
			%if data['form']['report_type'] != 'contract':
				...
				%if old_subgroup_name:
					<tr>
						...
						<td class='detail' width='1%' align='left'>&nbsp;</td>
						%if data['form']['report_type'] == 'product':
							<td class='subtotal' width='10%' align='left' colspan='11'>Total of ${old_subgroup_name}</td>
						%else:
							<td class='subtotal' width='10%' align='left' colspan='11'>Total of ${old_subgroup_name}</td>
						%endif:			
						<td class='subtotal' width='5%' align='right'>${formatLang(subgroup_product_uom_qty or 0.0,dp='Product Unit of Measure')}</td>
				...
				%if old_group_name:
					<tr>
						<td class='detail' width='1%' align='left'>&nbsp;</td>
						<td class='subtotal' width='1%' align='left' colspan='12'>Total of ${group_name}</td>
						<td class='subtotal' width='5%' align='right'>${formatLang(group_product_uom_qty or 0.0,dp='Product Unit of Measure')}</td>
						<td class='subtotal' width='5%' align='right'>${formatLang(group_bal_qty or 0.0,dp='Product Unit of Measure')}</td>
						<td class='subtotal' width='5%' align='right' colspan='11'>&nbsp;</td>
					</tr>
			...
			%if old_loc_name:
				<tr>
					%if data['form']['report_type'] != 'contract':
						<td class='subtotal' width='1%' align='left' colspan='13'>Total of ${loc_name}</td>
					%else:
			...
			<tr>
				%if data['form']['report_type'] != 'contract':
					<td class='grandtotal' width='1%' align='left' colspan='13'>GRAND TOTAL</td>
				%else:
					<td class='grandtotal' width='1%' align='left' colspan='12'>GRAND TOTAL</td>
				%endif:
				<td class='grandtotal' width='5%' align='right'>${formatLang(grand_product_uom_qty or 0.0,dp='Product Unit of Measure')}</td>
				<td class='grandtotal' width='5%' align='right'>${formatLang(grand_bal_qty or 0.0,dp='Product Unit of Measure')}</td>
				<td class='grandtotal' width='5%' align='right' colspan='11'>&nbsp;</td>
			</tr>
		</table>		
	</body>
</html>