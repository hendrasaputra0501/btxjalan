		...
		<table width='100%' cellspacing='0' cellpadding='1'>
			...
			%for line in details:	
				...
				%if bale_bal_qty >= min_bale_bal_qty:
					...
					%elif data['form']['report_type'] == 'date':
						<%group_name = line['name'] or ''%>
						<%subgroup_name = line['blend'] or ''%>
					%endif:			

					%if data['form']['report_type'] != 'date':
			...
			<tr>
				...
				%else:
					<td class='grandtotal' width='1%' align='left' colspan='10'>GRAND TOTAL</td>
				%endif:
				...
				<td class='grandtotal' width='5%' align='right' colspan='8'>&nbsp;</td>
			</tr>
		</table>		
	</body>
</html>