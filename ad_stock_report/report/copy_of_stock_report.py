	...
	def generate_xls_report(self, parser, data, obj, wb):
		...
		if data['grouping']=='location':
			for inventory_type in parser._get_inventory_type(data): 
				...
				rowcount = 0
				ws.write_merge(rowcount,rowcount,0,17, c.name, title_style)
				rowcount+=1
				ws.write_merge(rowcount,rowcount,0,17, "STOCK STATUS - %s"%parser._get_mode(data), title_style)
				rowcount+=1
				ws.write_merge(rowcount+1,rowcount+1,0,1, "Class ID - %s"%inventory_type.name,normal_style)
				ws.write_merge(rowcount,rowcount,0,17, "As on - %s"%parser._get_date_range(data), title_style)
				rowcount+=3
				...
				for cols in range(4,18):
					if cols%2==0:
						ws.write(rowcount-1,cols,"Bales",th_both_style)
					elif cols%2!=0:
				...
				for parent_loc in available_parent:			
					...
					for location in parser._get_available_location(parent_loc,location_line):
						if location.id in location_line:
							ws.write_merge(rowcount,rowcount,0,17,location.name,normal_bold_style_b)
							rowcount+=1
						else:
							continue
						if stock_lines:
							...
							if location.id in stock_lines[parent_loc]:
								for bl in sorted(stock_lines[parent_loc][location.id].keys()):
										...
										for sd in stock_lines[parent_loc][location.id][bl][ct]:
											...
											for wax in sorted(stock_lines[parent_loc][location.id][bl][ct][sd].keys()):
												...
												if not cek_total_wax:
													ws.write_merge(rowcount,rowcount,1,3,"Subtotal:",subtotal_title_style)
													ws.write(rowcount,4,total_wax[1]!=0.0 and total_wax[1] or '',subtotal_style2)
													ws.write(rowcount,5,total_wax[2]!=0.0 and total_wax[2] or '',subtotal_style2)
													ws.write(rowcount,6,total_wax[3]!=0.0 and total_wax[3] or '',subtotal_style2)
													ws.write(rowcount,7,total_wax[4]!=0.0 and total_wax[4] or '',subtotal_style2)
													ws.write(rowcount,8,total_wax[5]!=0.0 and total_wax[5] or '',subtotal_style2)
													ws.write(rowcount,9,total_wax[6]!=0.0 and total_wax[6] or '',subtotal_style2)
													ws.write(rowcount,10,total_wax[7]!=0.0 and total_wax[7] or '',subtotal_style2)
													ws.write(rowcount,11,total_wax[8]!=0.0 and total_wax[8] or '',subtotal_style2)
													ws.write(rowcount,12,total_wax[9]!=0.0 and total_wax[9] or '',subtotal_style2)
													ws.write(rowcount,13,total_wax[10]!=0.0 and total_wax[10] or '',subtotal_style2)
													ws.write(rowcount,14,total_wax[11]!=0.0 and total_wax[11] or '',subtotal_style2)
													ws.write(rowcount,15,total_wax[12]!=0.0 and total_wax[12] or '',subtotal_style2)
													ws.write(rowcount,16,total_wax[13]!=0.0 and total_wax[13] or '',subtotal_style2)
													ws.write(rowcount,17,total_wax[14]!=0.0 and total_wax[14] or '',subtotal_style2)
													rowcount+=1
												current_wax=False
												for i in range(1,15):
													total_wax[i]=0.0
									...
									if not cek_total_blend:
										...
										ws.write(rowcount,5,total_blend[2]!=0.0 and total_blend[2] or '',subtotal_style2)
										ws.write(rowcount,6,total_blend[3]!=0.0 and total_blend[3] or '',subtotal_style2)
										ws.write(rowcount,7,total_blend[4]!=0.0 and total_blend[4] or '',subtotal_style2)
										ws.write(rowcount,8,total_blend[5]!=0.0 and total_blend[5] or '',subtotal_style2)
										ws.write(rowcount,9,total_blend[6]!=0.0 and total_blend[6] or '',subtotal_style2)
										ws.write(rowcount,10,total_blend[7]!=0.0 and total_blend[7] or '',subtotal_style2)
										ws.write(rowcount,11,total_blend[8]!=0.0 and total_blend[8] or '',subtotal_style2)
										ws.write(rowcount,12,total_blend[9]!=0.0 and total_blend[9] or '',subtotal_style2)
										ws.write(rowcount,13,total_blend[10]!=0.0 and total_blend[10] or '',subtotal_style2)
										ws.write(rowcount,14,total_blend[11]!=0.0 and total_blend[11] or '',subtotal_style2)
										ws.write(rowcount,15,total_blend[12]!=0.0 and total_blend[12] or '',subtotal_style2)
										ws.write(rowcount,16,total_blend[13]!=0.0 and total_blend[13] or '',subtotal_style2)
										ws.write(rowcount,17,total_blend[14]!=0.0 and total_blend[14] or '',subtotal_style2)
										rowcount+=1
									current_blend=False
									for i in range(1,15):
										total_blend[i]=0.0
								...
								ws.write(rowcount,5,total_location[2]!=0.0 and total_location[2] or '',subtotal_style2)
								ws.write(rowcount,6,total_location[3]!=0.0 and total_location[3] or '',subtotal_style2)
								ws.write(rowcount,7,total_location[4]!=0.0 and total_location[4] or '',subtotal_style2)
								ws.write(rowcount,8,total_location[5]!=0.0 and total_location[5] or '',subtotal_style2)
								ws.write(rowcount,9,total_location[6]!=0.0 and total_location[6] or '',subtotal_style2)
								ws.write(rowcount,10,total_location[7]!=0.0 and total_location[7] or '',subtotal_style2)
								ws.write(rowcount,11,total_location[8]!=0.0 and total_location[8] or '',subtotal_style2)
								ws.write(rowcount,12,total_location[9]!=0.0 and total_location[9] or '',subtotal_style2)
								ws.write(rowcount,13,total_location[10]!=0.0 and total_location[10] or '',subtotal_style2)
								ws.write(rowcount,14,total_location[11]!=0.0 and total_location[11] or '',subtotal_style2)
								ws.write(rowcount,15,total_location[12]!=0.0 and total_location[12] or '',subtotal_style2)
								ws.write(rowcount,16,total_location[13]!=0.0 and total_location[13] or '',subtotal_style2)
								ws.write(rowcount,17,total_location[14]!=0.0 and total_location[14] or '',subtotal_style2)
								rowcount+=1
								# print "============================",rowcount
								current_location=False
								for i in range(1,15):
					...
					ws.write(rowcount,5,total_parent[2]!=0.0 and total_parent[2] or '',subtotal_style2)
					ws.write(rowcount,6,total_parent[3]!=0.0 and total_parent[3] or '',subtotal_style2)
					ws.write(rowcount,7,total_parent[4]!=0.0 and total_parent[4] or '',subtotal_style2)
					ws.write(rowcount,8,total_parent[5]!=0.0 and total_parent[5] or '',subtotal_style2)
					ws.write(rowcount,9,total_parent[6]!=0.0 and total_parent[6] or '',subtotal_style2)
					ws.write(rowcount,10,total_parent[7]!=0.0 and total_parent[7] or '',subtotal_style2)
					ws.write(rowcount,11,total_parent[8]!=0.0 and total_parent[8] or '',subtotal_style2)
					ws.write(rowcount,12,total_parent[9]!=0.0 and total_parent[9] or '',subtotal_style2)
					ws.write(rowcount,13,total_parent[10]!=0.0 and total_parent[10] or '',subtotal_style2)
					ws.write(rowcount,14,total_parent[11]!=0.0 and total_parent[11] or '',subtotal_style2)
					ws.write(rowcount,15,total_parent[12]!=0.0 and total_parent[12] or '',subtotal_style2)
					ws.write(rowcount,16,total_parent[13]!=0.0 and total_parent[13] or '',subtotal_style2)
					ws.write(rowcount,17,total_parent[14]!=0.0 and total_parent[14] or '',subtotal_style2)
					rowcount+=1
					# print "============================",rowcount
					current_parent=False
					for i in range(1,15):
			...
			ws.write(rowcount,5,grand_total[2]!=0.0 and grand_total[2] or '',subtotal_style2)
			ws.write(rowcount,6,grand_total[3]!=0.0 and grand_total[3] or '',subtotal_style2)
			ws.write(rowcount,7,grand_total[4]!=0.0 and grand_total[4] or '',subtotal_style2)
			ws.write(rowcount,8,grand_total[5]!=0.0 and grand_total[5] or '',subtotal_style2)
			ws.write(rowcount,9,grand_total[6]!=0.0 and grand_total[6] or '',subtotal_style2)
			ws.write(rowcount,10,grand_total[7]!=0.0 and grand_total[7] or '',subtotal_style2)
			ws.write(rowcount,11,grand_total[8]!=0.0 and grand_total[8] or '',subtotal_style2)
			ws.write(rowcount,12,grand_total[9]!=0.0 and grand_total[9] or '',subtotal_style2)
			ws.write(rowcount,13,grand_total[10]!=0.0 and grand_total[10] or '',subtotal_style2)
			ws.write(rowcount,14,grand_total[11]!=0.0 and grand_total[11] or '',subtotal_style2)
			ws.write(rowcount,15,grand_total[12]!=0.0 and grand_total[12] or '',subtotal_style2)
			ws.write(rowcount,16,grand_total[13]!=0.0 and grand_total[13] or '',subtotal_style2)
			ws.write(rowcount,17,grand_total[14]!=0.0 and grand_total[14] or '',subtotal_style2)
			rowcount+=1
