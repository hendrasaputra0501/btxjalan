...
class summary_stock_ageing_wizard(osv.osv_memory):
	_name = "summary.stock.ageing.wizard"
	_columns = {
		"as_on"			: fields.date("As On",required=False),
		"goods_type"	: fields.many2many("goods.type",'goods_type_summary_tock_ageing_rel','type_id','wizard_id',"Goods Type"),
		...
		"location_force": fields.many2many("stock.location","location_summary_stock_ageing_force_rel","location_id","wizard_id","Force Location"),
	...
	def generate_report(self,cr,uid,ids,context=None):
		...
		return {
                ...
                'report_name': 'summary.stock.ageing.report.xls',
                'report_type': 'webkit',
                'datas': datas,
                }