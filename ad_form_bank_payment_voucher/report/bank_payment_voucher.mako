<html>
	...
	%for voucher in objects:
		<center class="head_title"><h1>BANK PAYMENT VOUCHER</h1></center>
		...
		<table class="tr_description" width="100%">
			<tr>
				<td class="cq_1">Paid per 	<input type="checkbox" ${voucher.payment_adm in ('cheque') and 'checked="checked"' or ''}/> Cheque/Giro Bilyet No.</td>
				<td class="cq_2">&nbsp;</td>
				<td class="cq_3">Bank</td>
				<td class="cq_4">&nbsp;</td>
			</tr>
			<tr>
				<td style="padding-left:38px;" class="cq_1"><input type="checkbox" ${voucher.payment_adm in ('free_transfer','transfer','debit','bni_credit','cc','man_credit','bca_credit') and 'checked="checked"' or ''}/> Fund transfer</td>
				<td class="cq_2">&nbsp;</td>
				<td class="cq_3">Acc. No</td>
				<td class="cq_4">&nbsp;</td>
			</tr>
			<tr>
				<td style="padding-left:38px;" class="cq_1"><input type="checkbox" ${voucher.payment_adm in ('cash') and 'checked="checked"' or ''}/> Cash</td>
				<td class="cq_2">&nbsp;</td>
			</tr>
			<tr>
