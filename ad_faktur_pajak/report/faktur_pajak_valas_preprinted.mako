		...
		<table class="main" cellspacing="0">
			<tr>
				<td colspan="3" style="">
					...
					%>
					<div style="position:absolute;margin-left:225px; margin-top:55px;">${nomor}</div>
				</td>
			</tr>
			<tr height="5cm" style="">
			...
			<tr>
				<td colspan='3' style="padding-top:75px;">
					<table class="partner" border="0" style="margin-top:-7px;">
						<tr valign="top">
							<td><a>Nama</a></td>
							<td><a>:</a></td>
							<td class="label3" style="padding-left:115px;">${(o.partner_id and o.partner_id.title and o.partner_id.title.name) or ''} ${(o.partner_id and o.partner_id.name) or ''}<br /></td>
						</tr>
						<tr valign="top">
							<td><a>Alamat</a></td>
							<td><a>:</a></td>
							<td class="label3" style="padding-left:115px;">${alamat(o.partner_id and o.partner_id.id or False) or ''}</td>
						</tr>
						<tr valign="top">
							<td><a>NPWP</a></td>
							<td><a>:</a></td>
							<td class="label3" style="padding-left:115px;">${(o.partner_id and o.partner_id.npwp) or ''}</td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td style='width:40px' rowspan="2"><a>No.Urut</a></td>
				<td align="center" rowspan="2"><a>Nama Barang Kena Pajak / Jasa Kena Pajak</a></td>
				<td align="center" width="20%" colspan="2"><a>Harga Jual /Penggantian /Uang Muka /Termin *)</a></td>
			</tr>
			<tr>
				<td><a>Valas*)</a></td>
				<td><a>(Rp.)</a></td>
			...
			<tr class='inv_line'>
				...
				<td style="padding-right:85px; padding-top:5px;" align='right' width="30%">${invoice_line.invoice_id and invoice_line.invoice_id.currency_id and invoice_line.currency_id.name or ''} &nbsp; ${formatLang((invoice_line.price_subtotal) or "",digits=get_digits(dp='Faktur'))}</td>
				<td style="padding-right:55px; padding-top:5px;" align='right' width="30%">${formatLang(int((invoice_line.price_subtotal*last_cur_tax)) or "",digits=get_digits(dp='Faktur'))}</td>
			</tr>
			...
			<tr>
				<td colspan='2' style="height:0.1mm;">
					<p style="height:-2px;margin-top:15px;" valign="bottom">
					% if o.fp_harga_jual:
				...
				<td style="padding-top:-25px;height:0.1mm;padding-right:85px;text-align:right;">${invoice_line.invoice_id and invoice_line.invoice_id.currency_id and invoice_line.currency_id.name or ''} &nbsp; ${formatLang(tot,digits=get_digits(dp='Faktur'))}</td>
				<td style="height:0.1mm;padding-right:55px;text-align:right;">${formatLang(int(tot*last_cur_tax),digits=get_digits(dp='Faktur'))}</td>
			</tr>
			<tr>
				<td colspan='2' style="padding-top:-35px;height:0.1mm;"><a>Dikurangi potongan harga></a></td>
				<td style="padding-top:-35px;height:0.1mm;padding-right:85px;text-align:right;">0</td>
				<td style="padding-top:-35px;height:0.1mm;padding-right:55px;text-align:right;">0</td>
			</tr>
			<tr>
				<td colspan='2' style="padding-top:-25px;height:0.2mm;"><a>Dikurangi Uang Muka yang sudah diterima</a></td>
				<td style="height:0.2mm;padding-right:85px;text-align:right;">0</td>
				<td style="height:0.2mm;padding-right:55px;text-align:right;">0</td>
			</tr>
			<tr>
				<td colspan='2' style="padding-top:-25px;height:0.2mm;"><a>Dasar Pengenaan Pajak</a></td>
				<td style="padding-top:-25px;height:0.2mm;padding-right:85px;text-align:right;">${invoice_line.invoice_id and invoice_line.invoice_id.currency_id and invoice_line.currency_id.name or ''} &nbsp; ${formatLang(tot,digits=get_digits(dp='Faktur'))}</td>
				<td style="padding-top:-25px;height:0.2mm;padding-right:55px;text-align:right;">${formatLang(int(tot*last_cur_tax),digits=get_digits(dp='Faktur'))}</td>
			</tr>
			<tr>
				<td colspan='2' style="padding-top:-25px;height:0.1mm;"><a>PPN = 10% X Dasar Pengenaan Pajak</a></td>
				<td style="height:0.1mm;padding-right:85px;padding-top:-25px;text-align:right;">${invoice_line.invoice_id and invoice_line.invoice_id.currency_id and invoice_line.currency_id.name or ''} &nbsp; ${formatLang(tot_tax,digits=get_digits(dp='Faktur'))}</td>
				<td style="height:0.1mm;padding-right:55px;text-align:right;padding-top:-25px;"> ${formatLang(int(round(tot_tax*last_cur_tax)),digits=get_digits(dp='Faktur'))}</td>
			</tr>
			<tr>
				<td colspan='4'>
					<table width="100%" cellspacing='0' style="margin-top:-10px;" border="0">
						...
						<tr>
							...
							<td rowspan="2" width="30%" style="text-align:center;border: 0;padding-left:-110px;padding-right:110px;">
								<p style="margin-top:-6px;margin-bottom:20px;">${o.authorized_by and o.authorized_by.name.upper() or 'None' }</p><br/>
					...
					<p style="padding: 0; margin: 0; margin-top:-50px; padding-left:19mm;">${last_cur_kpmen}</p>
