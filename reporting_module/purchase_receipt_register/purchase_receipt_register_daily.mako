...
<body>
    ...
    <table style="page-break-before:always;vertical-align:top;width:98%;top:0;">
        <thead>
            ...
            <tr><td colspan="2" style="text-transform:uppercase;font-size:8px;">PO. Type: &nbsp; ${data['form']['purchase_type']}</td><td style="text-transform:uppercase;font-size:8px;"></td><td colspan="12" class="title" style="text-transform:uppercase;">PURCHASE RECEIPT RECORD DAILY</td><td colspan="2">&nbsp;</td><td>&nbsp;</td></tr>
            ...
            <tr>
                ...
                %for key_mrr in sorted(result_grouped[key_loc].keys(),key=lambda m:m[0]):
                    ...
                    %>
                        ...
                        # total_amt_usd+=get_usd*line['qty1']
                        total_qty+=line['qty1']
                        %>
                    % endfor
