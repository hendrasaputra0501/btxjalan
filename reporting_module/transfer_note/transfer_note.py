...
class transfer_note(report_sxw.rml_parse):
	
	def __init__(self, cr, uid, name, context):
		super(transfer_note, self).__init__(cr, uid, name, context=context)		
		#======================================================================= 
		self.line_no = 0
...
report_sxw.report_sxw('report.transfer.note.form', 'stock.picking', 'reporting_module/transfer_note/transfer_note.mako', parser=transfer_note,header=False)