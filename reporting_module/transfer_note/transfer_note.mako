...
<html>
    <head>
        ...
        <title>INVENTORY TRANSFER NOTE(OPENERP)</title>
        <style type="text/css">
            body {
                margin: 0px;
                padding: 0px;
    ...
    <body>
        ...
        <div class="head12"><a style="border-bottom:1px solid;">INVENTORY TRANSFER NOTE</a></div>
        % for o in objects:
        <div class="head2">
            &nbsp;<br />
