...
from report_webkit_custom.webkit_report import WebKitParser
...
class ReportXML(osv.osv):
    ...
    _columns = {
        ...
        'override_name': fields.text('Override Name',help="This field will be used to override the name of the file when downloading the report")
    }
