...
%>
<!-- 
	BC 4.1 Paper Size : 215 mm x 330 mm
	OpenERP Base Sample :
		Margin 
			Top 	: 0 mm 
			Bottom 	: 0 mm 
		...
		<table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
					<td class="tdnone" style="width: 4%;"></td>
					<td class="tdnone" style="width: 18%;"></td>
					<td class="tdnone" style="width: 29%;">${xupper(o.source_npwp)}</td>
					<td class="tdnone" style="width: 22%;"></td>
					<td class="tdnone" style="width: 22%;">${xupper(o.dest_npwp)}</td>
					<td class="tdnone" style="width: 5%;"></td>
				</tr>
			</tbody>
		</table>
		<table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				<tr>
					<td class="tdnone" style="width: 4%;"></td>
					<td class="tdnone" style="width: 18%;"></td>
					<td class="tdnone" style="width: 29%;">${xupper(o.source_partner_id.name)}</td>
					<td class="tdnone" style="width: 15%;"></td>
					<td class="tdnone" style="width: 29%;"></td>
					<td class="tdnone" style="width: 5%;"></td>
				</tr>
				<tr>
					<td class="tdnone" style="width: 4%;"></td>
					<td class="tdnone" style="width: 18%;"></td>
					<td colspan="1" rowspan="2" class="tdnone" style="width: 29%; vertical-align: top;">${xupper(o.source_address)}</td>
					<td class="tdnone" style="width: 15%;"></td>
					<td class="tdnone" style="width: 29%;">${xupper(o.dest_partner_id.name)}</td>
					<td class="tdnone" style="width: 5%;"></td>
				</tr>
				<tr>
					<td class="tdnone" style="width: 4%;"></td>
					<td class="tdnone" style="width: 18%;"></td>
					<td class="tdnone" style="width: 15%;"></td>
					<td colspan="1" rowspan="2" class="tdnone" style="width: 29%; vertical-align: top;">${xupper(o.dest_address)}</td>
					<td class="tdnone" style="width: 5%;"></td>
				</tr>
				<tr>
					<td class="tdnone" style="width: 4%;"></td>
